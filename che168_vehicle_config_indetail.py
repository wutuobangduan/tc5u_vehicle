...
def get_config_indetail(url,che168_model_id):
    ...
    if html != '':
        ...
        if chardet.detect(html)['encoding'] == 'GB2312':
            ...
            get_config_indetail(url,che168_model_id)
        ...
        for i in range(len(config_json['result']['paramtypeitems'])):
            for m in range(len(config_json['result']['paramtypeitems'][i]['paramitems'])):
                ...
                for n in range(len(config_json['result']['paramtypeitems'][i]['paramitems'][m]['valueitems'])):
                    if str(config_json['result']['paramtypeitems'][i]['paramitems'][m]['valueitems'][n]['specid']) == che168_model_id:
                        attr_value_dict["vname"] = config_json['result']['paramtypeitems'][i]['paramitems'][m]['valueitems'][n]['value']
        ...
        for i in range(len(option_json['result']['configtypeitems'])):
            for m in range(len(option_json['result']['configtypeitems'][i]['configitems'])):
                ...
                attr_value_dict["vid"] = 0
                for n in range(len(option_json['result']['configtypeitems'][i]['configitems'][m]['valueitems'])):
                    if str(option_json['result']['configtypeitems'][i]['configitems'][m]['valueitems'][n]['specid']) == che168_model_id:
                        attr_value_dict["vname"] = option_json['result']['configtypeitems'][i]['configitems'][m]['valueitems'][n]['value']
        ...
        if len(color_json['result']['specitems'])>0:
            for i in range(len(color_json['result']['specitems'])):
                if str(color_json['result']['specitems'][i]['specid']) == che168_model_id:
                    for m in range(len(color_json['result']['specitems'][i]['coloritems'])):
                        ...
                        color_result.append(color_json['result']['specitems'][i]['coloritems'][m])
...
def update_vehicle_model():
    try:
        ...
        for i in xrange(10000,17000):
            ...
            print url
            config_detail = get_config_indetail(url,str(get_che168_model_id[0]))
            print config_detail
